...
void LCD_Set_Pos(INT8U x, INT8U y)
{
    LCD_WrCmd(0xb0+y);
    LCD_WrCmd(((x&0xf0)>>4)|0x10);
    LCD_WrCmd((x&0x0f)|0x01); 
} 
void LCD_Fill(INT8U bmp_data)
{
    INT8U y,x;
...
{
    GPIO_InitTypeDef LCDGpios;
    LCDGpios.GPIO_PTx  = PTA;
    LCDGpios.GPIO_PinControl = IRQC_DIS | OUTPUT_DSH |PORT_PCR_SRE_MASK;
    LCDGpios.GPIO_Pins = 
        GPIO_Pin24|
        GPIO_Pin25|
        GPIO_Pin26|
        ...
        GPIO_Pin30|
        GPIO_Pin31;
    LCDGpios.GPIO_Dir = DIR_OUTPUT;
    LCDGpios.GPIO_Output = OUTPUT_H;
    LPLD_GPIO_Init(LCDGpios);
...
//==============================================================
//函数名： void LCD_PutPixel(INT8U x,INT8U y)
//功能描述：绘制一个点（x,y）
...
//==============================================================
//函数名： void LCD_Rectangle(INT8U x1,INT8U y1,
//                   INT8U x2,INT8U y2,INT8U color,INT8U gif)
//功能描述：绘制一个实心矩形
...
//==============================================================
//函数名：LCD_P6x8Str(INT8U x,INT8U y,INT8U *p)
//功能描述：写入一组标准ASCII字符串
...
//==============================================================
//函数名：LCD_P8x16Str(INT8U x,INT8U y,INT8U *p)
//功能描述：写入一组标准ASCII字符串
//参数：显示的位置（x,y），y为页范围0～7，要显示的字符串
//返回：无
//==============================================================  
...
//==============================================================
//函数名： void Draw_BMP(INT8U x,INT8U y)
//功能描述：显示BMP图片128×64
...
/********************************************/ /*
                                                  函数名: Dis_Num(INT8U y, INT8U x, uint num,INT8U N) 
                                                  ...
                                                  无
                                                *//********************************************/
void Dis_Num(INT8U y, INT8U x, INT32U num,INT8U N) 
{
    INT8U j=0;
    INT8U n[7]={0};
    x=x*8;
...
/********************************************/ /*
                                                  函数名: Dis_Float(INT8U Y,INT8U X,double real,INT8U N) 
                                                  ...
                                                  无
                                                *//********************************************/
void Dis_Float(INT8U Y,INT8U X,double real,INT8U N) 
{
    INT8U   i_Count=1;
    INT8U   n[12]={0};
    long   j=1;  
    INT32U   real_int=0;
    double decimal=0;
    INT32U   real_decimal=0;
    X=X*8;
    real_int=(int)real;
    //Dis_Num(2,0,real_int,5);
    decimal=real-real_int;
    real_decimal=(int)(decimal*1e4);
