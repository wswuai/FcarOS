...
#define CAN_BAUD_RATE_50KBPS    (50000)
#define CAN_BAUD_RATE_100KBPS   (100000)
#define CAN_BAUD_RATE_250KBPS   (250000)
#define CAN_BAUD_RATE_500KBPS   (500000)
#define CAN_BAUD_RATE_1MBPS     (1000000)
...
typedef enum CAN_Msg_Code_Tag
{
  ...
  CAN_MSGOBJ_TX_UNCONDITIONAL = 0xC,  //@emem TX Unconditional
